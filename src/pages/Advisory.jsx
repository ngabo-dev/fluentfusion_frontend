  ...
  return (
    ...
    <div className="relative font-sans before:absolute before:w-full before:h-full before:inset-0 before:bg-black before:opacity-50 before:z-10">
      ...
      <div className="min-h-[550px] relative h-full max-w-6xl mx-auto flex flex-col justify-center items-center text-center text-white p-6">
        <h2 className="text-5xl font-bold mb-4 flex flex-col items-center justify-center text-pink-600 z-20 mr-auto mt-20">
        Expert Advisory and Support<br></br>for Urban Planning Excellence
        </h2>
      </div>
    </div>
