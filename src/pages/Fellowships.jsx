  ...
  return (
    <div className="font-[sans-serif] py-10">
      <div className=" w-full h-96">
        <img src="/Green City.jpeg" alt="Banner Image" className="w-full h-full object-cover" />
      </div>
        ...
        <div className="mx-auto max-w-6xl shadow-lg p-8 relative bg-white rounded-md">
          ...
          <form className="mt-8 grid sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="text" placeholder="Enter your level of education"
                className="w-full rounded-md py-2.5 px-4 border border-gray-300 text-sm outline-pink-600" />
            </div>
            <div>
              <label className="text-gray-800 text-sm block mb-2">Field Of Education</label>
              <input type="text" placeholder="Enter your field of education"
                className="w-full rounded-md py-2.5 px-4 border border-gray-300 text-sm outline-pink-600" />
            </div>
            <div>
              <label className="text-gray-800 text-sm block mb-2">Work Organisation Or University</label>
              <input type="text" placeholder="Enter your work organisation or university"
                className="w-full rounded-md py-2.5 px-4 border border-gray-300 text-sm outline-pink-600" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="text" placeholder="Enter the name of professional body"
                className="w-full rounded-md py-2.5 px-4 border border-gray-300 text-sm outline-pink-600" />
            </div>
            <div>
              <label className="text-gray-800 text-sm block mb-2">Upload Your CV and Degree</label>
              <input type="file"
                className="w-full rounded-md py-2.5 px-4 border border-gray-300 text-sm outline-pink-600" />
            </div>
