        ...
        >
          <div className="p-4 w-full max-w-lg sm:max-w-xl lg:max-w-2xl bg-white rounded-lg shadow-lg border-t-8 border-t-emerald-800 overflow-y-auto max-h-[80vh]">
            ...
            <div className="p-4 md:p-5 space-y-4 text-sm sm:text-base leading-relaxed text-gray-700">
              <p>
              Hyacinthe NGWIJABAGABO is a lecturer at University of Rwanda, College of Science and Technology, School of Architecture and Built Environment, Spatial Planning Department. He is Geographer and environmentalist, holding MSc in Geo-Information for Environment and Sustainable Development). He is researcher with numerous publications in different journals. He Geo-spatial technology master for environment and biodiversity conservation. He also has great experience in built environment through academia and government institutions.
              </p>
            </div>
          </div>
        </div>
