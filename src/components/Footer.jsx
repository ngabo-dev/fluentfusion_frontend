      ...
      <div class="py-14 px-6 sm:px-10">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul class="flex gap-4">
              <li><a href="https://www.facebook.com/profile.php?id=100064515589711">
              ...
              <li><a href="https://www.linkedin.com/in/nextgen-urban-link-hub-380a87333/" class="text-white hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="fill-gray-300 inline hover:fill-white w-6 h-6"
                  viewBox="0 0 24 24">
                  <path fill-rule="evenodd"
              ...
              <li><a href="https://www.instagram.com/ngulinkhub?igsh=MTI3eWpjZXprYzVvMg==" class="text-white hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="fill-gray-300 inline hover:fill-white w-6 h-6"
                  viewBox="0 0 24 24">
                  <path
              ...
              <li><a href="https://x.com/NGULinkHub?t=g_2HGF66R3lTPSxzPQn5xQ&s=09" class="text-white hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="fill-gray-300 inline hover:fill-white w-6 h-6"
                  viewBox="0 0 24 24">
                  <path
